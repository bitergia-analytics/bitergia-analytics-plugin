...
describe('/api/create_tenant', () => {
  ...
  it('Creates tenant, roles and dashboards', async () => {
    ...
    expect(response.body.data).toMatchObject({
      ...
      roles: {
        response: [
          "'bap_plugins_visibility' created.",
  ...
  it('Fails if role already exists', async () => {
    ...
    expect(roles).not.toContain('bap_plugins_visibility');
  ...
  it('Overwrites roles and tenant', async () => {
    ...
    expect(response.body.data).toMatchObject({
      ...
      roles: {
        response: [
          "'bap_plugins_visibility' updated.",
